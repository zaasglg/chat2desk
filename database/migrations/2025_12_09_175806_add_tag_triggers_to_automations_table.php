        ...
        if ($driverName === 'sqlite') {
            ...
            DB::statement("
                CREATE TABLE automations_new (
                    ...
                    description TEXT,
                    channel_id INTEGER,
                    trigger VARCHAR(255) NOT NULL DEFAULT 'new_chat' CHECK(trigger IN ('new_chat', 'keyword', 'no_response', 'scheduled')),
                    trigger_config TEXT,
                    is_active BOOLEAN NOT NULL DEFAULT 1,
                    created_at DATETIME,
                    updated_at DATETIME,
            ...
            DB::statement("
                ...
                WHERE trigger IN ('new_chat', 'keyword', 'no_response', 'scheduled')
            ");
            ...
            // MySQL: revert enum
            DB::statement("ALTER TABLE automations MODIFY COLUMN trigger ENUM('new_chat', 'keyword', 'no_response', 'scheduled') NOT NULL DEFAULT 'new_chat'");
        }
    }
};
